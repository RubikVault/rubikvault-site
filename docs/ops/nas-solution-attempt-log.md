...
Generated at: 2026-04-12T13:46:18.536Z
...
- Current note: refresh_history_sample: 54/56 erfolgreich, 2 fehlgeschlagen; letzter Grund: process_exit_zero
...
| 1D Isolated Fetcher Service | covered_by_report | mixed_results | refresh_history_sample: 54/56 erfolgreich, 2 fehlgeschlagen; letzter Grund: process_exit_zero |
...
- Current note: fundamentals_sample: 1/56 erfolgreich, 55 fehlgeschlagen; letzter Grund: provider_chain_failed
...
| 3I Multi-Provider-Aggregator | covered_by_report | mixed_results | fundamentals_sample: 1/56 erfolgreich, 55 fehlgeschlagen; letzter Grund: provider_chain_failed |
...
- Current note: q1_delta_ingest_smoke: 54/54 fehlgeschlagen; letzter Grund: nonzero_exit | q1_delta_preflight: 20/20 fehlgeschlagen; letzter Grund: nonzero_exit
...
| 4J Preflight Validation CLI | live_probe | verified_failure | q1_delta_ingest_smoke: 54/54 fehlgeschlagen; letzter Grund: nonzero_exit | q1_delta_preflight: 20/20 fehlgeschlagen; letzter Grund: nonzero_exit |

## P05 QuantLab Integration

- Section status: mixed_results
- Current evidence: `quantlab_v4_daily_report`, `quantlab_boundary_audit`
- Current note: quantlab_v4_daily_report: 1/56 erfolgreich, 55 fehlgeschlagen; letzter Grund: missing_dependency | quantlab_boundary_audit: 20/20 fehlgeschlagen; letzter Grund: missing_quantlab_path
...
| 5I Boundary Audit | live_probe | mixed_results | quantlab_v4_daily_report: 1/56 erfolgreich, 55 fehlgeschlagen; letzter Grund: missing_dependency | quantlab_boundary_audit: 20/20 fehlgeschlagen; letzter Grund: missing_quantlab_path |
...
- Current note: daily_learning_cycle: 51/51 fehlgeschlagen; letzter Grund: nonzero_exit | runtime_control_probe: 20/20 fehlgeschlagen; letzter Grund: nonzero_exit

| Variant | Catalog status | Current evidence status | Current note |
|---|---|---|---|
| 6A Offline Learning Mode | queued_design | not_yet_tested | Noch nicht implementiert; aktuell nur als Backlog-Variante erfasst. |
| 6B Out-of-band Batch Processing | covered_by_report | verified_failure | daily_learning_cycle: 51/51 fehlgeschlagen; letzter Grund: nonzero_exit | runtime_control_probe: 20/20 fehlgeschlagen; letzter Grund: nonzero_exit |
...
| 6E Last-known-good Runtime Control | live_probe | verified_failure | daily_learning_cycle: 51/51 fehlgeschlagen; letzter Grund: nonzero_exit | runtime_control_probe: 20/20 fehlgeschlagen; letzter Grund: nonzero_exit |
...
| 6J Learning komplett aus Online-Pipeline entfernen | covered_by_report | verified_failure | daily_learning_cycle: 51/51 fehlgeschlagen; letzter Grund: nonzero_exit | runtime_control_probe: 20/20 fehlgeschlagen; letzter Grund: nonzero_exit |

## P07 best_setups_v4

- Section status: verified_failure
- Current evidence: `best_setups_v4_smoke`
- Current note: best_setups_v4_smoke: 20/20 fehlgeschlagen; letzter Grund: nonzero_exit
...
- Current note: ui_contract_probe: 20/20 fehlgeschlagen; letzter Grund: nonzero_exit
...
| 8C API-first Rendering | live_probe | verified_failure | ui_contract_probe: 20/20 fehlgeschlagen; letzter Grund: nonzero_exit |
...
- Current note: universe_audit_sample: 52/52 erfolgreich; letzter Lauf ok. | ui_contract_probe: 20/20 fehlgeschlagen; letzter Grund: nonzero_exit

| Variant | Catalog status | Current evidence status | Current note |
|---|---|---|---|
| 9A Contract-Based UI Testing | live_probe | mixed_results | universe_audit_sample: 52/52 erfolgreich; letzter Lauf ok. | ui_contract_probe: 20/20 fehlgeschlagen; letzter Grund: nonzero_exit |
...
| 9F UI Audit komplett von Daily Core entkoppeln | covered_by_report | mixed_results | universe_audit_sample: 52/52 erfolgreich; letzter Lauf ok. | ui_contract_probe: 20/20 fehlgeschlagen; letzter Grund: nonzero_exit |

## P10 md0 / Root-FS / Scheduler

- Section status: mixed_results
- Current evidence: report-only / blocker-only
- Current note: Systemaudit vorhanden, aktuell ohne harte Blocker im letzten Snapshot.
...
| 10B Read-only Root Audit | covered_by_report | mixed_results | Systemaudit vorhanden, aktuell ohne harte Blocker im letzten Snapshot. |
| 10C Root-FS Monitoring Daemon | covered_by_report | mixed_results | Systemaudit vorhanden, aktuell ohne harte Blocker im letzten Snapshot. |
...
| 10G Scheduler Externalization | covered_by_report | mixed_results | Systemaudit vorhanden, aktuell ohne harte Blocker im letzten Snapshot. |
| 10H Supervisor statt DSM-Scheduler | covered_by_report | mixed_results | Systemaudit vorhanden, aktuell ohne harte Blocker im letzten Snapshot. |
