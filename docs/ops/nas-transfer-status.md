...
| Q1 delta ingest | RED | 7A Boundary audit | NO (7 offen) | q1_delta_ingest_smoke + q1_delta_preflight |
...
| Dashboard V7 all green on NAS | RED | full chain only after blockers clear | NO (15 offen) | reality-check + blockers |
