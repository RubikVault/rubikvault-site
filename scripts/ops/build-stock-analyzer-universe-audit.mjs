...
const FIELD_PROBLEM_MAP = [
  ...
  { key: 'model_consensus_degraded|model_consensus_missing', uiField: 'Model Evidence Panel', severity: 'warning', rootCause: 'Model consensus finalInterpretation missing', repairStep: 'forecast_daily' },
  { key: 'model_consensus_degraded|*', uiField: 'Model Evidence (degraded)', severity: 'warning', rootCause: 'One or more model lanes degraded', repairStep: 'forecast_daily' },
