...
async function main() {
  ...
  output.system = {
    ...
    green_contract: {
      ...
      items: [
        'Single writer: the NAS supervisor is the only resident writer for authoritative latest artifacts.',
        'Full-universe audit proves artifact completeness separately from live canaries.',
        'Hist-Probs no-data / insufficient-history / inactive states are neutral, not missing UI truth.',
        'Fundamentals remain warning-only in prioritized scope and never become Final-Seal blockers.',
        'Q1/Market-Data may be ahead of the release target; only lag is critical.',
      ],
    },
