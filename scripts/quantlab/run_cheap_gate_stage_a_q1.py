...
def main(argv: Iterable[str]) -> int:
    ...
    add_variant("CSMOM", "csmom_20_trend_liq_soft", 0.63 * pl.col("z_ret_20d") + 0.11 * pl.col("trend_gate") + 0.26 * pl.col("z_liq"))
    add_variant("CSMOM", "csmom_ret5_trend_liq_soft", 0.49 * pl.col("z_ret_20d") + 0.15 * _z(pl.col("ret_5d")) + 0.10 * pl.col("trend_gate") + 0.26 * pl.col("z_liq"))
    add_variant("CSMOM", "csmom_ret5_macd_liq_soft", 0.47 * pl.col("z_ret_20d") + 0.15 * _z(pl.col("ret_5d")) + 0.10 * pl.col("z_macd_hist") + 0.28 * pl.col("z_liq"))
