...
export RV_EODHD_BULK_MIN_ROWS_MATCHED="${RV_EODHD_BULK_MIN_ROWS_MATCHED:-1000}"
# Universe scope: global_registry (broad 86k) | index_core (curated core)
export RV_UNIVERSE_SCOPE_MODE="${RV_UNIVERSE_SCOPE_MODE:-global_registry}"
export RV_INDEX_CORE_INCLUDE_EXTENDED="${RV_INDEX_CORE_INCLUDE_EXTENDED:-0}"
export RV_INDEX_CORE_INCLUDE_VALIDATED_NASDAQ_EXTENSION="${RV_INDEX_CORE_INCLUDE_VALIDATED_NASDAQ_EXTENSION:-0}"
export RV_INDEX_CORE_MAX_PROVIDER_CALLS="${RV_INDEX_CORE_MAX_PROVIDER_CALLS:-1500}"
