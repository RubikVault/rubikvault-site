...
export async function onRequestGet(context) {
  ...
  return jsonEnvelopeResponse({
    ...
    headers: {
      ...
      'X-Run-Id': result.meta?.run_id || '',
      'X-Canonical-Asset-Id': result.meta?.canonical_asset_id || result.data?.canonical_asset_id || '',
      'X-Data-Freshness': result.meta?.status || 'error',
    },
  });
}
