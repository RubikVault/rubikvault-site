...
export async function onRequest(context) {
  ...
  const staticPath = "/data/bundle.json";
  ...
  try {
    ...
    if (!res.ok) {
      return json(mkEnvelope({
        ok: false, feature: "bundle", data: null,
    ...
    return json(mkEnvelope({ ok: true, feature: "bundle", data: parsed, error: null, staticPath, traceId }));
  } catch (e) {
    return json(mkEnvelope({
      ok: false, feature: "bundle", data: null,
