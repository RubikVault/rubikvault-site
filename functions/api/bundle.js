export async function onRequest(ctx) {
  ...
  // Always fetch the static JSON asset from the Pages site itself.
  // This keeps it 0€ + deterministic + cacheable, and avoids double-fetching upstream APIs.
  const assetUrl = new URL("/data/bundle.json", url.origin);
